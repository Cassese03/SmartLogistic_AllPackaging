    ...
    <div class="page">
        ...
        <div class="page-content">
            <div class="content-sticky-footer">
                ...
                <div class="w-100">
                    <h1 class="text-center text-white title-background">&nbsp;&nbsp;&nbsp;Scegli Un Tipo di
                        Documento</h1>
                </div>
                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <li class="list-group-item">
                        <a <?php echo 'href="/magazzino/carico03/11165/' . $d->Cd_Do . '"'; ?>class="media">
